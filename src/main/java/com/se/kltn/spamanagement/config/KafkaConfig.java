...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, AppointmentResponse> consumerFactory() {
        JsonDeserializer<AppointmentResponse> deserializer = new JsonDeserializer<>(AppointmentResponse.class);
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "spa-management-group_id");
